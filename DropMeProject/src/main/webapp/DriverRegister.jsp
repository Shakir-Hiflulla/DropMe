...
<head>
    ...
    <link rel="stylesheet" href="css/DruverRegister.css">
	<meta charset="UTF-8">
	<script>
...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="form">
                <h2>Sign up Here</h2>
                	<form action="VehicleRegister.jsp" method="post" onsubmit="return validatePassword()">
                		...
                		<input type="text" name="license" placeholder="Enter License Here" required >
				        ...
				        <button class="btnn" onclick="validatePassword()">Add Vehicle</button>
					</form>
